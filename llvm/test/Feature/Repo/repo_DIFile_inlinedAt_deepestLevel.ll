...
; directory of the function 'foo' are contributed to the 'test' repo hash calculation.
;
...
!1 = !DIFile(filename: "inline.c", directory: "/home/maggie/case")
!2 = !{}
...
!10 = !DIFile(filename: "./header/foo1.h", directory: "/home/maggie/case2")
