...
;
; Inputs/Foo,Bar are used as reference funcitons. If two functions have the same code but
; different column number (added some tabs in the function body), they have different hash
; value.
;
; Corresponding the source code:
;
; int Foo() {
; /*column change*/ return 1;
; }
;
; void Bar() {
;   Foo();
...
!8 = !DILocation(line: 2, column: 19, scope: !6)
