...
; The hash of fragment accumulates its dependent digest.
;
; RUN: rm -f %t.db
; RUN: env REPOFILE=%t.db llc -filetype=obj %S/Inputs/repo_hash_dependent.ll -o /dev/null 2>&1
...
@.str = private unnamed_addr constant [13 x i8] c"MyFirstTest\0A\00", align 1
