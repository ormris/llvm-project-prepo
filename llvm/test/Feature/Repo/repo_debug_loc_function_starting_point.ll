...
;
; Inputs/Foo,Bar are used as a reference funciton.
; TODO: If two functions have the same code but different function starting point, they have same hash value.
;
...
!6 = distinct !DISubprogram(name: "Bar", scope: !1, file: !1, line: 3, type: !7, isLocal: false, isDefinition: true, scopeLine: 3, isOptimized: false, unit: !0, retainedNodes: !2)
!7 = !DISubroutineType(types: !2)
!8 = !DILocation(line: 4, column: 3, scope: !6)
!9 = !DILocation(line: 5, column: 1, scope: !6)
!10 = distinct !DISubprogram(name: "Foo", scope: !1, file: !1, line: 7, type: !7, isLocal: false, isDefinition: true, scopeLine: 7, isOptimized: false, unit: !0, retainedNodes: !2)
!11 = !DILocation(line: 8, column: 3, scope: !10)

; TODO: Change pruned from false to true for both functions once support the relative line in the debug line info.
