...
; directory of the function 'baz' are contributed to the 'test' repo hash calculation.
;
...
!13 = !DIFile(filename: "header.h", directory: "/home/maggie/case2")
